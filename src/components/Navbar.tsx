...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div 
        className="fixed top-0 left-0 right-0 h-32 z-40 pointer-events-none backdrop-blur-[8px] transition-opacity duration-700"
        style={{
            ...
            {isExpandedDesktop && (
              ...
              >
                ...
                <div className="flex items-center gap-5 text-sm font-semibold text-black px-5 whitespace-nowrap">
                  <Dropdown>
                    ...
                    <Dropdown.Popover className="min-w-[260px] bg-white border-[1.5px] border-black/10 shadow-xl rounded-2xl p-1">
                      <Dropdown.Menu aria-label="Servicios" className="flex flex-col gap-1 w-full outline-none">
                        <Dropdown.Item id="doc" textValue="Legalización de Documentos" className="rounded-xl py-2 px-3 hover:bg-black/5 transition-colors cursor-pointer data-[hover=true]:bg-black/5">
                          <Label className="cursor-pointer">Legalización de Documentos</Label>
                        </Dropdown.Item>
                        <Dropdown.Item id="visados" textValue="Visados desde Cuba" className="rounded-xl py-2 px-3 hover:bg-black/5 transition-colors cursor-pointer data-[hover=true]:bg-black/5">
                          <Label className="cursor-pointer">Visados desde Cuba</Label>
                        </Dropdown.Item>
                        <Dropdown.Item id="arraigo" textValue="Arraigo Social y Residencia" className="rounded-xl py-2 px-3 hover:bg-black/5 transition-colors cursor-pointer data-[hover=true]:bg-black/5">
                          <Label className="cursor-pointer">Arraigo Social y Residencia</Label>
                        </Dropdown.Item>
                        <Dropdown.Item id="nacionalidad" textValue="Nacionalidad Española" className="rounded-xl py-2 px-3 hover:bg-black/5 transition-colors cursor-pointer data-[hover=true]:bg-black/5">
                          <Label className="cursor-pointer">Nacionalidad Española</Label>
                        </Dropdown.Item>
                        <Dropdown.Item id="reagrupacion" textValue="Reagrupación Familiar" className="rounded-xl py-2 px-3 hover:bg-black/5 transition-colors cursor-pointer data-[hover=true]:bg-black/5">
                  ...
                  <a href="#nosotros" className="hover:text-black/50 transition-colors">Sobre Nosotros</a>
                ...
                <div className="pr-1">
                  <Button 
                    size="sm" 
                    variant="outline"
                    className="font-semibold border-foreground/10 hover:bg-foreground hover:text-background rounded-full px-5 h-10 w-full whitespace-nowrap"
                  >
                    Contacto
                  </Button>
                </div>
            ...
            {!isScrolled && (
              ...
              >
                <Button 
                  size="sm" 
                  variant="outline"
                  className="font-semibold border-foreground/10 hover:bg-foreground hover:text-background rounded-full px-4 h-10 whitespace-nowrap"
                >
                  Contacto
                </Button>
              </motion.div>
          ...
          {isMobileOpen && isScrolled && (
            ...
            >
              <div className="flex flex-col gap-1 p-2 overflow-y-auto max-h-[60vh] custom-scrollbar">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex flex-col gap-1 pl-2">
                    <a href="#doc" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-semibold text-black transition-colors">Legalización de Documentos</a>
                    <a href="#visados" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-semibold text-black transition-colors">Visados desde Cuba</a>
                    <a href="#arraigo" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-semibold text-black transition-colors">Arraigo Social y Residencia</a>
                    <a href="#nacionalidad" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-semibold text-black transition-colors">Nacionalidad Española</a>
                    <a href="#reagrupacion" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-semibold text-black transition-colors">Reagrupación Familiar</a>
                    <a href="#todos" onClick={() => setIsMobileOpen(false)} className="px-4 py-2 hover:bg-black/5 rounded-xl text-[14px] font-bold text-black transition-colors flex items-center gap-2">Todos los servicios <span className="opacity-50">→</span></a>
                  </div>
                </div>

                <div className="h-[1px] bg-black/5 mx-4 my-2" />
                
                <a href="#nosotros" onClick={() => setIsMobileOpen(false)} className="px-4 py-3 hover:bg-black/5 rounded-2xl text-[15px] font-semibold text-black transition-colors">Sobre Nosotros</a>
              ...
              <div className="p-2 pt-1 mt-1 border-t border-black/5">
                <Button onClick={() => setIsMobileOpen(false)} className="w-full bg-foreground text-background font-semibold rounded-2xl h-11 text-[15px] shadow-md">
                  Contacto
                </Button>
              </div>
            </motion.div>
